...
/*TOP LEVEL PARENT ID 
	...
	Diese Funktion ist für das aktuelle Template unglaublich wichtig und muss unter allen Umständen 
	in der functions.php bleiben :)
*/
...
function twentyeleven_continue_reading_link() {
	return ' <a href="'. esc_url( get_permalink() ) . '">' . __( 'Weiterlesen', 'twentyeleven' ) . '</a>';
}
...
function js_search_filter( $query ) {
        if  ( $query->is_search ) {
        $query->set('post__not_in', array(300) );
    }
        return $query;
...
//Für die child Funktion bis unendliche Ebenen tief. Im Gegensatz zu is_child

	...
	*/
	$PageID	=	array(
		...
		$MainID['printSolution']['sc'] => array(
			...
			'projektgeschaeft-loesungstools' => array(
				'id' 	=> 98,
				'menu'	=> $MainID['printSolution']['sc'].'projektgeschaeft-loesungstools_overview'
			),
			'production-printing' => array(
				'id' 	=> 711,
				'menu'	=> $MainID['printSolution']['sc'].'production-printing_overview'
			),
			'papier' => array(
				'id' 	=> 99,
				'menu'	=> $MainID['printSolution']['sc'].'papier_overview'
			),
			'neue-medien' => array(
				'id' 	=> 100,
				'menu'	=> $MainID['printSolution']['sc'].'neue-medien_overview'
			),
			'unternehmen' 		=> array(
					'id' 	=> 104,

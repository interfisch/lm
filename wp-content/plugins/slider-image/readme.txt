...
Tags: slider, slideshow, wordpress slider, content slider, image slider, Photo Slider, slider plugin, responsive slider, carousel slider, wp slider, vertical slider, image slider,
...
**I have already purchased Multi Site version, how do I upgrade it to Developer version, without buying it again? - Slider**
...
**Is it possible to show portrate and landscape images with correct proportions? - Slider**
...
Slideshow border size . Set the border for the slideshow - Slider
Slideshow Border color. Select the border color for the slideshow - Slider
Slideshow Border radius. Set the border radious for the slideshow - Slider

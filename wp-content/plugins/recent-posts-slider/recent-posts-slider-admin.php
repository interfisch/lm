...
<?php  }else{ ?>
<br/>
<p class="pro_text">Premium version is available at just <span class="pro_price">$7</span> <a href="http://recent-posts-slider.com/rps-store/" target="_blank">(Buy via PayPal or CreditCard)</a></p>

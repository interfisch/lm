...
**Plugin Demo:** [RPS Pro Demo](http://recent-posts-slider.com/rps-pro-version-demo-theme1/)
> **Upgrade to RPS Pro to get the features listed below**>> * More Customization options for pagination position, style & arrow> * Three different templates to showcase your recent posts> * Support external images as well> * Responsive> * Easy color picker for customization> * Multiple slider on a same page of same width & height with different category & posts setting> * Random Posts
